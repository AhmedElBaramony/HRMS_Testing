...
public class Payroll {
    ...
    public Payroll(double baseSalary, double bonus, int tax, int deduction) {
        ...
        if(tax < 0) this.tax = 0;
        else if(tax > 100) this.tax = 100;
        else this.tax = tax;

        if(deduction < 0) this.deduction = 0;
        else if(deduction > 100) this.deduction = 100;
        else this.deduction = deduction;
    }
    ...
    public double calculateSalary(){
        double salary = this.baseSalary - (this.deduction * (this.baseSalary/100));
